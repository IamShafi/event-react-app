...
const CoverInfoOverlay = () => {
  return (
    ...
    >
      ...
      <p className="w-full max-w-[692px] text-center text-[14px] md:text-[16px] text-white font-inter font-[400] leading-[20px] md:leading-[30px] uppercase my-[20px] md:my-[30px]">
