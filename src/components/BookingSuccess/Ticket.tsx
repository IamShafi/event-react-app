      ...
      <div className="w-full max-w-[1200px] flex flex-col gap-[50px] items-center justify-center">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-[25px] w-full">
          ...
          <div className="w-full max-w-[364px] flex flex-col justify-center gap-4 bg-white rounded-[16px] p-6 shadow-md font-inter">
            <button className="cursor-pointer font-[900] text-[14px] lg:text-[16px] flex justify-center items-center gap-3 border border-[#E5E7EB] rounded-lg py-2 px-2 hover:bg-gray-50 transition">
            ...
            <button className="cursor-pointer font-[900] text-[14px] lg:text-[16px] flex items-center gap-3 border border-[#E5E7EB] rounded-lg py-2 px-2 hover:bg-gray-50 transition">
            ...
            <button className="cursor-pointer font-[900] text-[14px] lg:text-[16px] flex items-center gap-2 border border-[#E5E7EB] rounded-lg py-2 px-2 hover:bg-gray-50 transition">
              <div className="w-[80px] h-[52px] bg-black flex items-center justify-center">
