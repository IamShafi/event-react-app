...
const EarlyAccess = () => {
  return (
    <div className="w-full max-w-[1440px] mx-auto flex items-center justify-center">
      <section
        className="relative w-full flex items-center justify-center pb-[600px] md:pb-[40px]"
        style={{
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-[1200px] flex flex-col md:flex-row items-center justify-between gap-[20px] px-[20px] md:px-0 mt-[50px] md:mt-[106px]">
          <div className="flex flex-col w-full max-w-[470px]">
            ...
            {/* Input */}
            <form className="w-full h-[60px] flex items-center p-[5px]" style={{
              background: "#FFFFFF1A",
              backdropFilter: "blur(44px)",
              border: "1px solid",
              borderImageSlice: 1,
              borderImageSource: "linear-gradient(97.99deg, rgba(255, 255, 255, 0.8) -8.87%, rgba(255, 255, 255, 0) 17.27%, rgba(255, 255, 255, 0) 73.29%, rgba(255, 255, 255, 0.8) 100.55%)"
            }}>
              <input
                type="email"
              ...
              <button
                type="submit"
                className="cursor-pointer w-[198px] h-full bg-white text-black font-inter font-extrabold text-[16px] uppercase"
                style={{
