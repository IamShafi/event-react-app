...
const TicketPricesCard = () => {
  return (
    <div
      className="TicketPricesCard-Container w-full max-w-[1200px] flex flex-row gap-3 justify-between py-5 px-2.5 lg:p-[40px]"
      style={{
        border: "1px solid",
        borderImage:
    ...
    >
      {/* Ticket */}
      <div
        className="w-full max-w-[227px] lg:max-w-[380px] flex flex-col items-start border-r-0 lg:border-r"
        style={{
          borderImage:
      ...
      >
        ...
        {/* Book3 */}
        <div className="flex flex-col gap-[14px] mb-0 lg:mb-0 w-full sm:w-[227px] lg:w-[324px]">
          <h3 className="font-inter text-[14px] lg:text-[20px] font-[600] leading-[24px] text-white">
      ...
      {/* Price */}
      <div className="hidden lg:flex w-full max-w-[380px]  flex-col items-center gap-[71px] "        style={{
