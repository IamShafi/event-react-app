...
const SponsorCarousel = () => {
  return (
    <div className="w-full max-w-[1440px] mx-auto my-[60px] lg:mt-[80px] lg:mb-[100px] flex flex-col items-center">
      ...
      <div className="w-full max-w-[1440px] overflow-hidden hidden lg:flex flex-row gap-[130px] items-start justify-start 2xl:justify-center  overflow-x-auto scrollbar-hide">
        <img
          src={Icon1SVG}
          alt="about image"
